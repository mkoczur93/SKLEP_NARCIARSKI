<?php
	...
	{
		$_SESSION['udana'] = '<span style="color:green; font-size:20px">Udało ci się dodać nowego pracownika !</span>';
	...
	<div class="d-flex justify-content-center h-100">
		<div class="card">
			<div class="card-header">
				<h3 style="text-align: center;padding-bottom:20px;">Dodaj pracownika</h3>
			</div>
			<div class="card-body">
 <div class="col-md-6">
				<form method="post">
