...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <header>
      ...
      <!--Dropp end-->
            ...
            <li class="active"><a href="http://localhost/sklep_narciarski/public_html/noclegiAdmin.php">Noclegi</a></li>
    ...
    <div class="container">
      ...
      <div class="row no-gutters">
        ...
        <div class="col-md-12 nocleg ">		
          ...
          <div class="col-md-4">
					<figure>
							<img src="img/noclegi/nocleg1.jpg" alt="Obrazek_noclegi">							
					</figure>
		  ...
		  <div class="col-md-8">
					<div class="col-md-12">
								...
								<p><h3 class="nocleg">Pokoje Gościnne Wojciech Łukaszczyk </h1></p>
					</div>
					
				
					<div class="col-md-12">
				
					</p>Cena noclegu: 28-40 PLN od osoby. Ceny zależne od liczby osób oraz od długości pobytu. Ceny dla grup do uzgodnienia. 
					Ceny do negocjacji przy dłuższych pobytach. 
					Obiekt Do dyspozycji gości: pokoje z łazienkami oraz ogólnodostępne łazienki , świetlica , kominek. Na terenie obiektu parking. Właściciel posiada uprawnienia PRZEWODNIKA TATRZAŃSKIEGO. 
					Imprezy i konferencje Dla zainteresowanych organizujemy dyskoteki. Atrakcje w obiekcie 
					Dla dzieci plac zabaw. Gastronomia Liczba miejsc w lokalu: 60. 
					Średnia cena obiadu 12-13 PLN. Śniadanie 6-7 PLN. Kolacja 5-6 PLN. Położenie Do Krupówek 3 km, do Kuźnic 2,5 km. 
					Obiekt położony w dzielnicy Zakopanego - Olcza. 
					Atuty Na miejscu udzielamy rzetelnej informacji turystycznej - właściciel posiada uprawnienia przewodnika tatrzańskiego 
		...
		<!-- Nastepny nocleg -->
          ...
          <div class="col-md-4">
					<figure>
							<img src="img/noclegi/nocleg2.jpg" alt="Obrazek_noclegi">							
					</figure>
		  ...
		  <div class="col-md-8">
					...
					Obiekt położony w dzielnicy Zakopanego - Olcza. 
					Atuty Na miejscu udzielamy rzetelnej informacji turystycznej - właściciel posiada uprawnienia przewodnika tatrzańskiego 
					https://meteor-turystyka.pl/mrowce,zakopane.html </p>
		...
		<!-- Nastepny nocleg -->
          ...
          <div class="col-md-4">
					<figure>
							<img src="img/noclegi/nocleg3.jpg" alt="Obrazek_noclegi">							
					</figure>
		...
		<!-- Nastepny nocleg -->
          ...
          <div class="col-md-4">
					<figure>
							<img src="img/noclegi/nocleg4.jpg" alt="Obrazek_noclegi">							
					</figure>
