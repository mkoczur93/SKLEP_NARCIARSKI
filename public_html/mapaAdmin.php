...
<div class="container-fluid" style="background-color: #38465e; margin-top:20px;">
           ...
           <figure>
			<img src="img\trasy\mapa_duża.jpg" height="1358" width="1920" alt="mapka duża">							
	  </figure> 
    ...
    <div  style="max-width: 1920px;" >
            ...
            <ul aria-live="polite" >
                <li style="display: block; width: 100%; float: left; margin-right: -100%; position: relative; opacity: 1; z-index: 2;" 
                    <img src="img\trasy\mapa_duża.jpg" height="1358" width="1920" alt="Mapa zimowa Ośrodek ">
                </li>
            </ul>
