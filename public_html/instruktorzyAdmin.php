...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <header>
      ...
      <!--Dropp end-->
            ...
            <li class="active"><a href="http://localhost/sklep_narciarski/public_html/instruktorzyAdmin.php">Instruktorzy</a></li>
    ...
    <div class="container">
      ...
      <div class="row no-gutters">
        ...
        <div class="col-md-12 instruktor">		
          ...
          <div class="col-md-4">
					<figure>
						<img src="img/instruktorzy/instruktor1.jpg" alt="Obrazek_instruktora">							
					</figure>
		  ...
		  <div class="col-md-8">
					<div class="col-md-12">
								...
								<p><h3 class="nocleg">Jan Kowalski </h1></p>
					</div>
					
				
					<div class="col-md-12 instruktor-opis">                
						<p> Instruktor narciarstwa - kierownik szkolenia. Mgr Wychowania Fizycznego AWF Kraków, Instruktor PZN.

                            Instruktor Sportu Doświadczony siatkarz i narciarz.
                            Na studiach zasmakowałem wielu ciekawych sportów, ale te dwie dyscypliny fascynują mnie najbardziej.
                             Dlatego też uczenie narciarstwa, to pasja, która daje mi uśmiech na twarzy, gdy widzę kursanta śmigającego 
                             samodzielnie, a niespełna kilka lekcji wcześniej zaczynał swą przygodę. Potrafię nawiązywać rewelacyjny 
                             kontakt z ludźmi, przez co nie ustępuje, gdy nie zrobię z Ciebie narciarza ;) 
        ...
        <div class="col-md-12 instruktor">		
            ...
            <div class="col-md-4">
                      <figure>
                          <img src="img/instruktorzy/instruktor2.jpg" alt="Obrazek_instruktora">							
                      </figure>
            ...
            <div class="col-md-8">
                      <div class="col-md-12">
                                  ...
                                  <p><h3 class="nocleg">Monika Nowak </h1></p>
                      </div>
        ...
        <div class="col-md-12 instruktor">		
            ...
            <div class="col-md-4">
                      <figure>
                          <img src="img/instruktorzy/instruktor3.jpg" alt="Obrazek_instruktora">							
                      </figure>
            ...
            <div class="col-md-8">
                      <div class="col-md-12">
                                  ...
                                  <p><h3 class="nocleg">Natalia Stoklosa </h1></p>
                      </div>
        ...
        <div class="col-md-12 instruktor">		
            ...
            <div class="col-md-4">
                      <figure>
                          <img src="img/instruktorzy/instruktor4.jpg" alt="Obrazek_instruktora">							
                      </figure>
            ...
            <div class="col-md-8">
                      <div class="col-md-12">
                                  ...
                                  <p><h3 class="nocleg">Damian Wolny </h1></p>
                      </div>
