...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <header>
      ...
      <!--Dropp end-->
            ...
            <li class="active"><a href="http://localhost/sklep_narciarski/public_html/trasyAdmin.php">Trasy</a></li>
    ...
    <div class="container">
      ...
      <div class="row no-gutters">
		...
		<div class="col-md-12 instruktor-opis">                
			<p> Układ wyciągów i tras zjazdowych jest bardzo efektywnie zaplanowany, 
                            przez co można się tutaj naprawdę „najeździć”. 10 kilometrów terenów zjazdowych, 
                            w znacznej części sztucznie dośnieżanych, a także oświetlenie do jazd wieczornych to atuty ośrodka. 
                            Każdy odnajdzie swoją ulubioną trasę, niezależnie czy jest początkującym czy zaawansowanym narciarzem.
                        </p>
                ...
                <div class="col-md-12 instruktor-opis">                
                    <button class="nocleg" onclick="window.location.href='http://localhost/sklep_narciarski/public_html/mapa.php';">Zobacz na mapie ośrodka</button>
                </div>
		  ...
		  <div class="col-md-8">
					<div class="col-md-12">
								...
								<p><h3 class="nocleg">Plan ogólny tras</h1></p>
					</div>
					
				<figure>
						<img src="img\trasy\mapka_01.jpg" alt="mapka mala tras">							
				</figure>
		...
		<div class="col-md-12 instruktor-opis">                
			<p> Niewielkie nachylenie, bardzo szerokie stoki i zróżnicowana infrastruktura – to jest to, 
                            co początkujący lubią najbardziej. I to właśnie mamy – w dodatku z systemem sztucznego 
                            naśnieżania i oświetleniem. Żeby zabawa nie musiała się kończyć wraz z zachodem słońca!

                            Nasze polany: Bartusiowa, Jędrusiowa, Czarodziejska i Misiowa
                            Trasy łatwe – niebieskie: H, G i I

                            Dopiero zaczynasz przygodę z nartami lub deską? A może Twoje dziecko będzie stawiać 
                            swoje pierwsze kroki w zimowych zjazdach? Skorzystajcie z lekcji oferowanych przez naszych 
                            doświadczonych instruktorów. Aby dowiedzieć się więcej kliknij: instruktorzy.
		  ...
		  <div class="col-md-8">
					<div class="col-md-12">
								...
								<p><h3 class="nocleg">Dla początkujących: polany narciarskie i trasy łatwe</h1></p>
					</div>
					
				<figure>
						<img src="img\trasy\Trasy_początkujący.jpg">							
					</figure>
 ...
 <div class="col-md-12 instruktor">		
		...
		<div class="col-md-12 instruktor-opis">                
			<p> Dla średniozaawansowanych:
                            trasy średnio trudne
                            Jeżeli jesteś gotowy na więcej – przetestuj długie i żróżnicowane trasy czerwone. Wybierz swoją ulubioną i szusuj aż do nocy!

                            Trasy średnio-trudne – czerwone:
                            Helly Hansen B Fis, C Fis, D Fis, E i F Fis

                            Najdłuższa z nich, trasa B, na którą wjedziesz naszą super szybką Luxtorpedą, jest oświetlona! 1 680 m jeżdżenia od 9:00 do 21:00.
		  ...
		  <div class="col-md-8">
					<div class="col-md-12">
								...
								<p><h3 class="nocleg">Dla średniozaawansowanych:
trasy średnio trudne</h1></p>
					</div>
					
				<figure>
						<img src="img\trasy\Trasy_zaawansowanyjpg.jpg"   alt="zdjecie zawansowany">							
					</figure>
		...
		<div class="col-md-12 instruktor-opis">                
			<p> 
                            Dla szukający wrażeń i adrenaliny – przygotowaliśmy wyjątkowo wymagającą czarno – czerwoną trasę A, 
                            która pozwoli sprawdzić swoje możliwości najbardziej doświadczonym narciarzom.
                            Trasa trudna – czarno-czerwona: A (o długości 1 600 m) 
                        </p>
                </div>
		  ...
		  <div class="col-md-8">
                        <div class="col-md-12">
                             <p><h3 class="nocleg">Dla zaawansowanych: czarna ściana</h1></p>
                        </div>	
                        <figure>
                            <img src="img\trasy\trasy_zawansowany.jpg" alt="mapka tras">							
                        </figure>
                  </div>
         </div>
